const apiKey = '0RD1bFZVPmRSM4vGsGdH0GzCeUGaMqsx'
...
const updateUI = (data) => {
    ...
    details.innerHTML=`
    <h5 class="my-5">${cityDetails.EnglishName}, ${cityDetails.AdministrativeArea.EnglishName}, ${cityDetails.Country.EnglishName} </h5>
    <h5 class="my-5">Longi ${cityDetails.GeoPosition.Latitude} & Lati ${cityDetails.GeoPosition.Longitude} </h5>
